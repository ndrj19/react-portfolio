  ...
  return (
    ...
    >
            ...
            <div className="cards-wrapper w-100 d-flex justify-content-center px-3 gap-2">
              <div className="card rounded-4">
                <div
                  ...
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/furniture.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
                  ...
                  <p className="card-text">
                    ...
                    frontend, that fetches and displays product information from
                    a MySql database.
                  </p>
                </div>
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/academyPortal.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
                  <h4 className="card-title fw-bolder">Academy portal</h4>
                  <p className="card-text">
                    A Slim PHP app which allows to manage applicants, courses,
                    events, etc. at iO Academy. I worked on a new calendar
                    feature using a 3rd party plugin.
                  </p>
                </div>
                <div className="card-footer rounded-bottom-4 border-0">
                  <div className="d-flex column-gap-4">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/invoicing.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/chessclock.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/boneyard.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
                  <h4 className="card-title fw-bolder">Brainworms' Boneyard</h4>
                  <p className="card-text">
                    Brainworms' Boneyard is a spooky Pairs game written in
                    JavaScript, HTML and CSS coming in a spooky Halloween
                    edition.
                  </p>
                </div>
                <div className="card-footer rounded-bottom-4 border-0">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/pathogens.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/tipsplit.png");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
          ...
          <div className="carousel-item">
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  className="image-wrapper rounded-top-4"
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("assets/background-turquoise.jpg");'
                ></div>
                <div className="card-body border-top border-dark-subtle d-flex flex-column">
      ...
      <div
        ...
        className="py-3 px-4 carousel slide d-none d-sm-block d-md-none"
        data-bs-touch="true"
      >
        <div className="carousel-inner">
          <div className="carousel-item active">
      ...
      >
        ...
        <button
          className="carousel-control-prev"
          type="button"
          data-bs-target="#carousel-larger-screens"
          data-bs-slide="prev"
        >
          <span
            className="carousel-control-prev-icon"
