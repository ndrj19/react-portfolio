        ...
        <div className="cards-wrapper w-100 d-flex justify-content-center px-3 gap-2">
          <div className="card rounded-4">
            ...
            <div className="card-body border-top border-dark-subtle d-flex flex-column">
              ...
              <p className="card-text">
                An object-orientated PHP project with a provided React frontend,
                that fetches and displays product information from a MySql
                database.
              </p>
            </div>
          ...
          <div className="card rounded-4">
            ...
            <div className="card-body border-top border-dark-subtle d-flex flex-column">
              ...
              <p className="card-text">
                A React + Bootstrap project with a provided backend that allows
                the user to manage invoices.
              </p>
            </div>
            <div className="card-footer rounded-bottom-4 border-0">
              <div className="d-flex column-gap-4">
          ...
          <div className="card rounded-4">
            ...
            <div className="card-body border-top border-dark-subtle d-flex flex-column">
              ...
              <p className="card-text">
                A simple chess clock built with React. I use it when I'm playing
                with my dad and he forgot to bring a chess clock.
              </p>
            </div>
            <div className="card-footer rounded-bottom-4 border-0">
              <div className="d-flex column-gap-4">
      ...
      <div className="carousel-item">
        ...
        <div className="cards-wrapper d-flex justify-content-center gap-3">
          ...
          <div className="card rounded-4">
            ...
            ></div>
            <div className="card-body border-top border-dark-subtle d-flex flex-column">
              <h4 className="card-title fw-bolder">Pathogens Collection App</h4>
              <p className="card-text">
          ...
          <div className="card rounded-4">
            ...
            <div className="card-body border-top border-dark-subtle d-flex flex-column">
              ...
              <p className="card-text">
                A React app that allows you to quickly calculate the tip amount
                based on your bill.
              </p>
            </div>
            <div className="card-footer rounded-bottom-4 border-0">
