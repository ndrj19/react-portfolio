...
const CarouselSmallScreens = () => {
  return (
    <>
      <div
        id="carousel-xsmall-screens"
        className="py-3 px-4 carousel slide d-block d-sm-none pointer-event"
        data-bs-touch="true"
      >
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/academyPortal.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/invoicing.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/chessclock.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/boneyard.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/pathogens.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/tipsplit.png")',
                  }}
                ></div>
            ...
            <div className="cards-wrapper d-flex justify-content-center gap-3">
              <div className="card rounded-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.25)), url("../assets/background-turquoise.jpg")',
                  }}
                ></div>
...
export default CarouselSmallScreens;
